  ...
  <div class="list" style="margin-top:10px;">
        ...
        <template slot-scope="scope">
          <el-row>
            ...
            <el-button
              type="danger"
              size="small"
              @click="deleteDate(scope.row['_id'])"
            >删除</el-button>
            <el-button
              type="warning"
              size="small"
              @click="addPic(scope.row['_id'])"
            >添加图片</el-button>
          </el-row>
        </template>
      </el-table-column>
      ...
      <el-form :model="addForm" class="addForm">
        ...
        <el-form-item label="性别" :label-width="formLabelWidth">
          <el-select
            ...
            class="sexArea"
          >
            <el-option label="汉子" value="man" />
            <el-option label="妹子" value="woman" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="位置" :label-width="formLabelWidth">
          <el-input v-model="addForm.dowhat" auto-complete="off" />
        </el-form-item>

        <el-form-item label="台词" :label-width="formLabelWidth">
          <el-input v-model="addForm.favourite" auto-complete="off" />
        </el-form-item>

        <el-form-item label="背景" :label-width="formLabelWidth">
          <el-input v-model="addForm.explain" auto-complete="off" />
        </el-form-item>
      </el-form>
    ...
    >
      <el-form :model="modifyForm" class="addForm">
        <el-form-item label="名字" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.name" auto-complete="off" />
        </el-form-item>

        <el-form-item label="英雄" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.nickname" auto-complete="off" />
        </el-form-item>
        ...
        <el-form-item label="籍贯" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.address" auto-complete="off" />
        </el-form-item>

        <el-form-item label="位置" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.dowhat" auto-complete="off" />
        </el-form-item>

        <el-form-item label="台词" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.favourite" auto-complete="off" />
        </el-form-item>

        <el-form-item label="背景" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.explain" auto-complete="off" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
    ...
    >
      <el-form :model="addpicform">
        <el-form-item label="图片地址" :label-width="formLabelWidth">
          <el-input v-model="addpicform.url" auto-complete="off" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
    ...
    getAll: function() {
      ...
      get_heros(query)
        .then(res => {
          ...
          this.dataTotal = res.headers["x-header"];
        })
        .catch(error => {
          this.loading = false;
          console.log(error);
